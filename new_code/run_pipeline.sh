...
tmux send-keys "$KAFKA_HOME/bin/zookeeper-server-start.sh $KAFKA_HOME/config/zookeeper.properties" C-m
sleep 2
...
tmux send-keys "$KAFKA_HOME/bin/kafka-server-start.sh $KAFKA_HOME/config/server.properties" C-m
sleep 2
